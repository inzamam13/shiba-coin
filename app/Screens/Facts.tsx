...
import { Conclusion, data } from "../utils/Data";
import {
  Dimensions,
  Image,
  ScrollView,
...
const Facts = ({ navigation }: any) => {
  ...
  return (
    <>
      ...
      >
        <Image source={require('../assets/images/21.jpg')} style={{width: '70%',alignSelf: 'center', height: '80%'}} resizeMode={"contain"} />
        {Conclusion.map((item) => {
          return (
            <>
              <TouchableOpacity
