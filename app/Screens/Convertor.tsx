...
import { AdvanceConcept, data } from "../utils/Data";
...
const Convertor = ({ navigation }: any) => {
  ...
  return (
    <>
      {/* <Header title="Advanced Concepts" /> */}
      <ScrollView
      ...
      >
        <Image source={BOK} resizeMode={"contain"} />
        {AdvanceConcept.map((item) => {
          return (
            <>
              <TouchableOpacity
                onPress={() =>
                  navigation.navigate(NavigationNames.CustomPar, {
                    text: { ...item, type: "basic" },
                  })
                }
                style={{
